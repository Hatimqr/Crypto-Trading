...
- Implementing a Deep Q-Network (DQN) where the state will be represented by recent price movements and technical indicators
- The action space will include discrete options for buying, selling, or holding with different magnitude levels.
- Reward function will be based on risk-adjusted returns
- Potentially also exploring policy gradient approaches

### **Stochastic Process Approach:**

- Modeling Bitcoin price movements using geometric Brownian motion
- Implementing Monte Carlo simulations to generate potential price paths
- Using the simulation results to estimate probability distributions of future prices
- $d_t$’s will depend on the resulting distribution.
...
- Profit factor: Sum of gains from profitable decisions divided by sum of losses
...
4. Profit factor of at least 1.5 will indicate success.
